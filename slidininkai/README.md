...
* [Pamokoje naudojama IT egzamino užduotis](https://nec.lt/failai/7417_IT-VBE-1_2018-GALUTINE.pdf) 🖥️
...
Pagal eilučių kiekį patikrinkime ar teisingai įvesti duomenys. Nustatome kiek eilučių turi failas:
      ...
      ivestosEilutes_Rez = len(open(DUOMENŲ_IŠVEDIMO_FAILAS.txt).readlines())
...
Aprašykime sėkmingo scenarijaus rezultatą, ištrinkime duomenų įvedimo failą ir atidarykime rezultatų failą.
      ...
      def pvz1:
         ...
         check50.run("> DUOMENŲ_ĮVEDIMO_FAILAS.txt").exit(0)
